...
const Card = ({ title, body, date, status, handleArchiveNote, handleDeleteNote, handleUnarchiveNote }) => {
  return (
    <div className="border-2 border-black border-solid rounded-[20px] w-[286px] max-sm:w-full max-md:w-[286px] h-[238px] shadow-card px-4 pt-[20px] pb-[20px] flex flex-col justify-between">
      <div>
